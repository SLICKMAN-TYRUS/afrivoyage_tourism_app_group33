        ...
        listener: (context, state) {
          ...
          if (state is AuthAuthenticated) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('${l10n.passwordResetSentPrefix} ${state.email}'),
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (v) {
                ...
                if (!AuthRepository().validateEmail(v)) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (AuthRepository().validateEmail(ctrl.text)) {
                context
                    .read<AuthBloc>()
            ...
            InkWell(
              ...
              child: InputDecorator(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: _dateOfBirth != null ? null : Colors.grey[500],
                  ),
                ),
              ),
            ),
  ...
  Widget _accountTypeOption({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: [
            Icon(icon, size: 28, color: selected ? primary : Colors.grey),
            const SizedBox(height: 6),
            Text(label,
                style: TextStyle(
